const CACHE_NAME = "life-ledger-pwa-1.1.1";
const APP_SHELL = [
  "./",
  "./index.html",
  "./styles.css?v=1.1.1",
  "./app.js?v=1.1.1",
  "./focus-timer.js?v=1.1.1",
  "./voice-checkin.js?v=1.1.1",
  "./photo-memories.js?v=1.1.1",
  "./media-backup.js?v=1.1.1",
  "./deployment-mode.js?v=1.1.1",
  "./cloudbase-sync.js?v=1.1.1",
  "./vendor/cloudbase-sdk.js",
  "./_init_tcb-env.js?v=1.1.1",
