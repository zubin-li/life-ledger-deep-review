const CACHE_NAME = "life-ledger-pwa-1.2.0";
const APP_SHELL = [
  "./",
  "./index.html",
  "./styles.css?v=1.2.0",
  "./app.js?v=1.2.0",
  "./focus-timer.js?v=1.2.0",
  "./voice-checkin.js?v=1.2.0",
  "./photo-memories.js?v=1.2.0",
  "./media-backup.js?v=1.2.0",
  "./deployment-mode.js?v=1.2.0",
  "./cloudbase-sync.js?v=1.2.0",
  "./vendor/cloudbase-sdk.js",
  "./_init_tcb-env.js?v=1.2.0",
