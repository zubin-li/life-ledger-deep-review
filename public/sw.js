const CACHE_NAME = "life-ledger-pwa-1.1.4";
const APP_SHELL = [
  "./",
  "./index.html",
  "./styles.css?v=1.1.4",
  "./app.js?v=1.1.4",
  "./focus-timer.js?v=1.1.4",
  "./voice-checkin.js?v=1.1.4",
  "./photo-memories.js?v=1.1.4",
  "./media-backup.js?v=1.1.4",
  "./deployment-mode.js?v=1.1.4",
  "./cloudbase-sync.js?v=1.1.4",
  "./vendor/cloudbase-sdk.js",
  "./_init_tcb-env.js?v=1.1.4",
