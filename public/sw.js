const CACHE_NAME = "life-ledger-pwa-1.1.2";
const APP_SHELL = [
  "./",
  "./index.html",
  "./styles.css?v=1.1.2",
  "./app.js?v=1.1.2",
  "./focus-timer.js?v=1.1.2",
  "./voice-checkin.js?v=1.1.2",
  "./photo-memories.js?v=1.1.2",
  "./media-backup.js?v=1.1.2",
  "./deployment-mode.js?v=1.1.2",
  "./cloudbase-sync.js?v=1.1.2",
  "./vendor/cloudbase-sdk.js",
  "./_init_tcb-env.js?v=1.1.2",
