const CACHE_NAME = "life-ledger-pwa-1.1.3";
const APP_SHELL = [
  "./",
  "./index.html",
  "./styles.css?v=1.1.3",
  "./app.js?v=1.1.3",
  "./focus-timer.js?v=1.1.3",
  "./voice-checkin.js?v=1.1.3",
  "./photo-memories.js?v=1.1.3",
  "./media-backup.js?v=1.1.3",
  "./deployment-mode.js?v=1.1.3",
  "./cloudbase-sync.js?v=1.1.3",
  "./vendor/cloudbase-sdk.js",
  "./_init_tcb-env.js?v=1.1.3",
...
self.addEventListener("fetch", event => {
  ...
  const networkFirst = ["/app.js", "/focus-timer.js", "/voice-checkin.js", "/photo-memories.js", "/media-backup.js", "/styles.css", "/deployment-mode.js", "/cloudbase-sync.js", "/_init_tcb-env.js"]
