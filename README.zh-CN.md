...
未来版本计划支持连接自己的 AI 服务与 API Key，根据自己的历史记录生成每周、每月甚至每年的复盘报告。

你的数据不会成为别人的产品，而会成为帮助自己成长的基础。

AI 不负责替你思考。它只是帮助你更好地看见自己。

> **路线图说明：** AI 辅助复盘属于未来规划，当前 Beta 版本尚未包含该功能。
...
<p align="center">
  <img src="docs/images/demo-preview/zh-desktop/04-monthly-review.png" width="100%" alt="Life Ledger 中文桌面版月度复盘" />
</p>
...
<table>
  <tr>
    <td width="50%"><img src="docs/images/demo-preview/zh-desktop/01-today-planning.png" alt="每日目标与每日复盘" /></td>
    <td width="50%"><img src="docs/images/demo-preview/zh-desktop/03-weekly-plan.png" alt="本周目标与本周输出" /></td>
  </tr>
  <tr>
...
<p align="center">
  <img src="docs/images/demo-preview/zh-mobile/01-today-planning.png" width="30%" alt="手机版每日规划" />
  <img src="docs/images/demo-preview/zh-mobile/02-daily-review.png" width="30%" alt="手机版单日复盘" />
  <img src="docs/images/demo-preview/zh-mobile/04-monthly-review.png" width="30%" alt="手机版月度复盘" />
</p>
